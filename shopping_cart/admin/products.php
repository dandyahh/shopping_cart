...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
        ...
        <div class="inputBox">
            <span>Gambar 01 (dibutuhkan)</span>
            <input type="file" name="Gambar_01" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
        </div>
        <div class="inputBox">
            <span>Gambar 02 (dibutuhkan)</span>
            <input type="file" name="Gambar_02" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
        </div>
        <div class="inputBox">
            <span>Gambar 03 (dibutuhkan)</span>
            <input type="file" name="Gambar_03" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
        </div>
         <div class="inputBox">
            <span>Detail Produk (dibutuhkan)</span>
